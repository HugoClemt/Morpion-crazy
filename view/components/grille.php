<div class="grille">
    ...
    <div class="row quadrillage">
        <div class="col">
            <input class="case" type="text" id="case-3" onclick="exec(cases[3]);" readonly>
            <input class="case" type="text" id="case-4" onclick="exec(cases[4]);" readonly>
            <input class="case" type="text" id="case-5" onclick="exec(cases[5]);" readonly>
        </div>
    </div>
