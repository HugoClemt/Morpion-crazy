        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form label="infoSolo" method="post" action="./model/add_pseudo.php">
                    <div class="card">
                        <input type="text" name="pseudoSolo" id="pseudoSolo" placeholder="Entrer votre pseudo"
                            required="required">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                <a href="?page=template-grilleSolo"><button type="submit" class="btn btn-primary">Jouer</button></a>
            </div>
        </div>
    </div>
</div>